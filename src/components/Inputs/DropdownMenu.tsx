...
>(({ className, children, ...props }, forwardedRef) => (
  <DropdownMenuPrimitives.SubTrigger
    ...
    className={cx(
      ...
      // disabled
      "data-[disabled]:pointer-events-none data-[disabled]:text-zinc-400 data-[disabled]:hover:bg-none dark:data-[disabled]:text-zinc-400",
      // focus
      "focus-visible:bg-zinc-100 data-[state=open]:bg-zinc-100 focus-visible:dark:bg-zinc-100 data-[state=open]:dark:bg-zinc-100",
      // hover
      "hover:bg-zinc-100 hover:dark:bg-zinc-100",
      //
      className,
    )}
    {...props}
  ...
  <DropdownMenuPrimitives.Portal>
    <DropdownMenuPrimitives.SubContent
      ...
      className={cx(
        ...
        // background color
        "bg-white dark:bg-whte",
        // text color
        "text-zinc-900 dark:text-zinc-90",
        // border color
...
>(({ className, shortcut, hint, children, ...props }, forwardedRef) => (
  <DropdownMenuPrimitives.Item
    ...
    className={cx(
      ...
      "data-[disabled]:pointer-events-none data-[disabled]:text-zinc-400 data-[disabled]:hover:bg-none dark:data-[disabled]:text-zinc-400",
      // focus
      "focus-visible:bg-zinc-100 focus-visible:dark:bg-zinc-100",
      // hover
      "hover:bg-zinc-100 hover:dark:bg-zinc-100",
      className,
    )}
  ...
  >
    ...
    {hint && (
      <span
        className={cx("ml-auto pl-2 text-sm text-zinc-400 dark:text-zinc-400")}
      >
        {hint}
      </span>
    )}
    ...
    >
      <span className="absolute left-2 flex size-4 items-center justify-center">
        <DropdownMenuPrimitives.ItemIndicator>
          <RiCheckLine
            aria-hidden="true"
            className="size-full shrink-0 text-zinc-800 dark:text-zinc-800"
          />
        </DropdownMenuPrimitives.ItemIndicator>
      </span>
      {children}
      {hint && (
        <span
          className={cx(
            "ml-auto text-sm font-normal text-zinc-400 dark:text-zinc-400",
          )}
        >
          {hint}
        </span>
      ...
      {shortcut && (
        <span
          className={cx(
            "ml-auto text-sm font-normal tracking-widest text-zinc-400 dark:border-zinc-400 dark:text-zinc-400",
          )}
        >
          {shortcut}
        </span>
...
>(({ className, hint, shortcut, children, ...props }, forwardedRef) => (
  ...
  >
    <span className="absolute left-2 flex size-4 items-center justify-center">
      ...
      <RiCheckboxBlankCircleLine
        aria-hidden="true"
        className="size-full shrink-0 text-zinc-300 group-data-[state=unchecked]/DropdownMenuRadioItem:flex group-data-[state=checked]/DropdownMenuRadioItem:hidden dark:text-zinc-300"
      />
    </span>
    {children}
    {hint && (
...
>(({ className, ...props }, forwardedRef) => (
  <DropdownMenuPrimitives.Separator
    ref={forwardedRef}
    className={cx(
      "-mx-1 my-1 h-px border-t border-zinc-200 dark:border-zinc-200",
      className,
    )}
    {...props}
  />
  ...
  return (
    <div
      className={cx(
        ...
        // disabled
        "group-data-[disabled]/DropdownMenuItem:text-zinc-400 group-data-[disabled]/DropdownMenuItem:dark:text-zinc-400",
        className,
      )}
      {...props}
    />
