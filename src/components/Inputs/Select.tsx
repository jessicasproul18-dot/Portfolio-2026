...
const selectTriggerVariants = tv({
  base: cx(
    // base
    "group/trigger flex w-full select-none items-center justify-between gap-2 truncate px-3 py-2 outline-none transition sm:text-sm",
    // border color
    "border-zinc-600",
    // text color
    "text-zinc-100",
    ...
    "hover:bg-zinc-700",
    // disabled
    "data-[disabled]:bg-zinc-700 data-[disabled]:text-zinc-500",
    focusInput,
  ),
  variants: {
    variant: {
