    ...
    <DialogPortal>
      <DialogOverlay>
        <DialogPrimitives.Content
          ...
          className={cx(
            // base
            "fixed left-1/2 top-1/2 z-50 w-[95vw] max-w-lg -translate-x-1/2 -translate-y-1/2 overflow-y-auto border p-6 shadow-lg",
            // border color
            "border-zinc-600",
            // background color
            "bg-zinc-800",
        ...
        >
          ...
          {children}
          {/* Add a hidden title if no DialogTitle is found in children */}
...
>(({ className, ...props }, forwardedRef) => {
  return (
    <DialogPrimitives.Description
      ref={forwardedRef}
      className={cx("text-zinc-400", className)}
      {...props}
    />
  )
})
