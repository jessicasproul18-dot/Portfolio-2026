    ...
    <DrawerPortal>
      <DrawerOverlay>
        <DrawerPrimitives.Content
          ...
          className={cx(
            // base
            "fixed inset-y-0 z-50 mx-auto flex w-[95vw] flex-1 flex-col overflow-y-auto border p-4 shadow-lg focus:outline-hidden max-sm:inset-x-0 sm:inset-y-0 sm:right-0 sm:max-w-lg sm:p-6",
            // border color
