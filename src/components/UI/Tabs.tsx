...
type TabsListVariant = "line" | "solid" | "solidTop"
  ...
  switch (tabVariant) {
    case "line":
      return cx(
        ...
        // selected
        "data-[state=active]:border-alice_blue-500 data-[state=active]:text-alice_blue-500",
        // disabled
    ...
    case "solid":
      return cx(
        ...
        // disabled
        "data-disabled:pointer-events-none data-disabled:text-zinc-400 data-disabled:opacity-50",
      )
    case "solidTop":
        return cx(
          // base
