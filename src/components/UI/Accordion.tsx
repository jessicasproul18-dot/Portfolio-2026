  ...
  <AccordionPrimitives.Header className="flex">
    <AccordionPrimitives.Trigger
      className={cx(
        ...
        "text-zinc-100",
        // disabled
        "data-disabled:cursor-default data-disabled:text-zinc-500",
        //focus
        "focus-visible:z-10 focus-visible:ring-2 focus-visible:ring-[#C7AE7F] focus-visible:outline-hidden focus-visible:ring-inset",
        className,
      )}
      {...props}
      ref={forwardedRef}
    >
      ...
      <RiAddLine
        className={cx(
          ...
          "text-zinc-400",
          // disabled
          "group-data-disabled:text-zinc-300",
        )}
        aria-hidden="true"
        focusable="false"
      />
